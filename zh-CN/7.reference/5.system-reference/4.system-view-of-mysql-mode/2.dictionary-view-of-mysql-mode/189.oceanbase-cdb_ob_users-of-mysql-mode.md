...
| PASSWD                    | varchar(128)  | NO   |  用户密码   |
| INFO                      | varchar(4096) | NO   |  用户信息   |
...
| PRIV_GRANT_OPTION         | varchar(3)    | NO   |  授予当前用户的权限   |
...
| PRIV_CREATE_USER          | varchar(3)    | NO   |  创建用户的权限   |
| PRIV_SUPER                | varchar(3)    | NO   |  超级用户权限   |
| IS_LOCKED                 | varchar(3)    | NO   |  用户是否锁定   |
